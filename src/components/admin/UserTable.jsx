...
const UserTable = () => {
  const sampleUsers = [
    { id: 1, name: "Nguyễn Văn A", address: "Hà Nội", phone: "0987654321", createdAt: "2024-03-10", role: "Admin", status: "Hoạt động" },
    { id: 2, name: "Trần Thị B", address: "TP. Hồ Chí Minh", phone: "0912345678", createdAt: "2024-02-15", role: "User", status: "Bị khóa" },
  ];
