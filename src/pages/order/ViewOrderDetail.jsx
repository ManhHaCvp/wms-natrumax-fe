...
import {checkUserRole, checkUserRoleById} from "@/utils/checkUserRole";
import {
    Dialog,
    DialogContent,
    DialogHeader,
                                    ...
                                    <Table>
                                        ...
                                        <TableFooter>
                                            <TableRow>
                                                ...
                                                <TableCell
                                                    className="text-right">{totalPrice.toLocaleString()} VND</TableCell>
                                            </TableRow>
                                        </TableFooter>
                                    </Table>
                                </div>
                                    ...
                                    <Table>
                                        ...
                                        <TableFooter>
                                            <TableRow>
                                                ...
                                                <TableCell
                                                    className="text-right">{(totalPrice - discountAmount).toLocaleString()} VND</TableCell>
                                            </TableRow>
                                        </TableFooter>
                                    </Table>
                                </div>
                                    ...
                                    <ul className="space-y-5">
                                        {order.orderModifyHistories.map((orderModifyHistory, index) => (
                                            <li key={index} className="relative flex items-start">
                                                {/* Circle indicator */}
                                                <div
                                                    className="absolute top-2 w-3 h-3 bg-[#182f73] rounded-full border-2 border-white"></div>
